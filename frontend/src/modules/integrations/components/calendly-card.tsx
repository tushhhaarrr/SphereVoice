...
/**
 * CalendlyCard — displays connection status and connect/disconnect
 * controls for the Calendly integration.
 */
...
import {
    ...
    useInitiateCalendlyOAuth,
    useSyncCalendly,
} from "../hooks/use-calendly-integrations";
import type { CalendlyIntegration } from "../types";
...
export function CalendlyCard({ integration, tenantId }: CalendlyCardProps) {
    const [confirmDisconnect, setConfirmDisconnect] = useState(false);

    const initiate = useInitiateCalendlyOAuth();
    const sync = useSyncCalendly(tenantId);
    const disconnect = useDisconnectCalendly(tenantId);
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-xs">
                                Check availability & share scheduling links during calls
                            </CardDescription>
                        </div>
                    </div>
            ...
            <AlertDialog open={confirmDisconnect} onOpenChange={setConfirmDisconnect}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will remove the Calendly connection. Your agents will no
                            longer be able to check availability or share scheduling links.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
